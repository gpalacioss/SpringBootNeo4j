package com.practica.primerEjemplo.config.security;
...
import com.practica.primerEjemplo.models.security.ConstantsSecurity;
...
public class JwtTokenUtil implements Serializable {
	...
	private String doGenerateToken(String subject, String pass) {
		...
		return Jwts.builder()
				...
				.setExpiration(new Date(System.currentTimeMillis() + ConstantsSecurity.ACCESS_TOKEN_VALIDITY_SECONDS * 100))
